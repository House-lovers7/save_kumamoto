...
export const actionCards: ActionCard[] = [
  ...
  },
  {
    ...
    "caution": "この案内は給水を保証しません。給水所は日ごとに変わり、前日までで終了した場所があります。出発前に当日の告知を確認してください。",
    "verifyPoints": [
      {
    ...
    "facts": [
      ...
      },
      {
        ...
        "items": [
          ...
          "電話もつながりにくい場合がありますので、可能な限りメールにて相談・申込"
        ],
        "citedAs": "【対応窓口】"
      }
    ],
