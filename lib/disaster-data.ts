 ...
 * 期限は確認から24時間。
 */
const PATROL_AT = "2026-07-31T18:30:00+09:00";
const PATROL_EXPIRES_AT = "2026-08-01T18:30:00+09:00";
...
export const actionCards: ActionCard[] = [
  {
    ...
    // 2026-07-31 巡回: 最新掲載は「令和8年熊本地震に係る災害対策本部会議」（2026-07-30）。
  ...
  },
  {
    ...
    // 2026-07-31 巡回: 令和8年熊本地震の集約ページとして掲載継続（同日更新）。
  ...
  },
  {
    ...
    // 手順1の「場所と時間を確認する」が実行できなかった。再選定先は市内72箇所の施設名・
    // 所在地・利用可能時間の一覧と、飲料用／生活用水の区別、容器の自己準備をすべて掲載している。
    ...patrolled("2026-07-31T00:00:00+09:00"),
  ...
  },
  {
    ...
    sourceName: "熊本市",
    sourceUrl: "https://www.city.kumamoto.jp/list04828.html",
    // 2026-07-31 巡回: 旧出典（県 防災推進課）に食料・物資の入手案内はなかった。県の災害対応
    // ページと熊本市の「義援物資について」はいずれも物資を送る支援者向けで、熊本市は
    // 「個人の皆様からの義援物資の受入れは行っておりません」と明記している。被災者が
    // 配布を受ける場所と時間の公式案内は確認できていない。
    ...patrolled("2026-07-31T00:00:00+09:00", "unavailable"),
    unverified:
      "食料・生活用品の配布場所と時間をまとめた公式案内は、2026年7月31日の巡回では確認できませんでした。リンク先は熊本市の災害情報の集約ページです。",
    areas: ["熊本市"],
    offline: true,
  },
  {
    ...
    title: "給油できる場所を探す",
    summary:
      "給油できる場所や給油制限をまとめた公式案内は、今回の巡回では見つかりませんでした。県の災害情報を見たうえで、各事業者の公式情報を直接確認してください。",
    steps: [
    ...
    // 2026-07-31 巡回: 県 防災推進課・県の令和8年熊本地震ページ・熊本市の集約ページの
    // いずれにも、燃料や給油に関する記載がなかった。
    ...patrolled("2026-07-31T00:00:00+09:00", "unavailable"),
    unverified:
      "給油できる場所と給油制限の公式案内は、2026年7月31日の巡回では確認できませんでした。リンク先は熊本県の令和8年熊本地震に関する情報ページです。",
    areas: ["熊本県全域"],
    offline: true,
  },
  {
    ...
    // 2026-07-31 巡回: 旧出典（県 防災推進課）にトイレ・断水の記載はなかった。熊本市上下水道局の
    // サイトは緊急情報を後から読み込む作りで、静的には「データ取得中」しか出ず内容を確認できない。
    // 再選定先の災害ごみページで確認できるのはごみの分別・排出方法までで、携帯トイレやし尿の
    // 処分方法は記載がない。
    ...patrolled("2026-07-31T00:00:00+09:00", "unavailable"),
    unverified:
      "断水中のトイレ・携帯トイレ・し尿の処分方法の公式案内は、2026年7月31日の巡回では確認できませんでした。リンク先で確認できるのは災害ごみの出し方です。",
    areas: ["熊本市"],
    offline: true,
  },
  {
    ...
    title: "乳幼児用品と預け先を探す",
    summary:
      "ミルク・離乳食・おむつの配布先と授乳場所をまとめた公式案内は、今回の巡回では見つかりませんでした。保育施設の開園状況は公式に出ています。",
    steps: [
    ...
    // 2026-07-31 巡回: 旧出典（県 防災推進課）に乳幼児支援の記載はなかった。再選定先の
    // 保育施設ページで確認できるのは開園状況までで、ミルク・離乳食・おむつの配布先や
    // 授乳・休憩場所の記載はない。私立施設は個別の問い合わせを案内している。
    ...patrolled("2026-07-29T00:00:00+09:00", "unavailable"),
    unverified:
      "ミルク・離乳食・おむつの配布先と授乳・休憩場所の公式案内は、2026年7月31日の巡回では確認できませんでした。リンク先で確認できるのは保育施設の開園状況です。",
    areas: ["熊本市"],
    offline: true,
  },
  {
  ...
  },
  {
    ...
    // 2026-07-31 巡回: トップに「避難所情報」の導線が掲載継続。配備体制状況の更新は 2026-07-28 16:49。
  ...
  },
  {
    ...
    // 2026-07-31 巡回: 掲載継続（2026-07-29 更新）。保険証がなくても受診できる旨を確認。
    ...patrolled("2026-07-29T00:00:00+09:00"),
    areas: ["熊本県全域"],
    offline: true,
  },
  {
    ...
    // 2026-07-31 巡回: 掲載継続。ページに最終更新日の表示がないため、publishedAt は本文が明記する
    // サービス開始日（令和8年4月1日）まで切り下げる。実際より新しく見せないための保守側の値。
  ...
  },
  {
    ...
    // 2026-07-31 巡回: 道路情報への導線と令和8年熊本地震の対応記事が掲載継続。ページに
    // 最終更新日の表示がないため、publishedAt は地震発生日（2026-07-28）まで切り下げる。
    ...patrolled("2026-07-28T00:00:00+09:00"),
    areas: ["熊本県全域"],
    offline: true,
  },
  {
  ...
  },
  {
    ...
    sourceName: "熊本市",
    sourceUrl: "https://www.city.kumamoto.jp/list04828.html",
    // 2026-07-31 巡回: 集約ページから「被災者支援制度（冊子）」（2026-07-30 更新）と
    // 「住家の緊急の修理」制度へ導線あり。10日以内という完了期限は後者のページの記載。
